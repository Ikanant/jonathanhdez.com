...
<body>
			...
			<section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Check if a String has unique characters</h4>
                      <form id="myForm" class="form-horizontal style-form">
                          ...
                          <div class="form-group">
                              ...
                              <label class="col-sm-6 col-sm-6 control-label" style="font-weight:bold"> www.jonathanhdez.com/api/hasUniqueChars</label>
                          </div>
	...
	<script>
		$('#myForm').submit(function(event) {
			...
			$.getJSON("${pageContext.request.contextPath}/api/hasUniqueChars",{ str:$('#inputStr').val()}).done( 
		   		function(hasUniqueChars) {
		                $("#resultBox").text(hasUniqueChars.hasUniqueChars);
		                $("#resultBoxJSON").text(JSON.stringify(hasUniqueChars));
			    }).fail(
		   		function(){
