...
<body>
			...
			<section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Get String Length</h4>
                      <form id="myForm" class="form-horizontal style-form">
                          ...
                          <div class="form-group">
                              ...
                              <label class="col-sm-6 col-sm-6 control-label" style="font-weight:bold"> jonathanhdez.com/api/stringCharCount</label>
                          </div>
	...
	<script>
		$('#myForm').submit(function(event) {
			...
			$.getJSON("${pageContext.request.contextPath}/api/stringCharCount",{ str:$('#inputStr').val()}).done( 
		   		function(greet) {
		                $("#resultBox").text(greet.count);
