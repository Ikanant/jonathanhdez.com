...
<body>
			...
			<section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Hello World</h4>
                      <form id="hello" class="form-horizontal style-form">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <span class="help-block">Default = "World".</span>
                                  <button type="submit" id="callHello" class="btn btn-theme">Submit</button>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <label href="jonathanhdez.com/api/greeting" class="col-sm-6 col-sm-6 control-label" style="font-weight:bold"> jonathanhdez.com/api/greeting</label>
                          </div>
	...
	<script>
		$('#hello').submit(function(event) {
			...
			$.getJSON("${pageContext.request.contextPath}/api/greeting",{ name:$('#inputStr').val()}).done( 
		   		function(greet) {
		                $("#resultBox").text(greet.greeting);
		                $("#resultBoxJSON").text(JSON.stringify(greet));
			    }).fail(
		   		function(){
